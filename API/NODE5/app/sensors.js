function lm35(min, max) {
    min = typeof min == 'undefined' ? 22 : min;
...
function dht11(options){
    ...
    if (minHumidity < 40 || maxHumidity > 54) {
    ...
    minTemperature = typeof minTemperature == 'undefined' ? 22 : minTemperature;
    maxTemperature = typeof maxTemperature == 'undefined' ? 27 : maxTemperature;

   

    minHumidity = typeof minHumidity == 'undefined' ? 20 : minHumidity;
    maxHumidity = typeof maxHumidity == 'undefined' ? 50 : maxHumidity;
